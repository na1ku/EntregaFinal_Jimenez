...
class VideojuegoTestCase(TestCase):
    ...
    def test_agregar_videojuego(self):
        ...
        data = {'nombre': 'Nuevo Juego', 'fecha_salida': '2024-06-19', 'genero': 'Estrategia', 'empresa': 'DesarrolladorY', 'descripcion': 'Un juego nuevo', 'valoracion': 3}
    ...
    def test_editar_videojuego(self):
        ...
        data = {'nombre': 'Juego Modificado', 'fecha_salida': '2024-12-01', 'genero': 'Aventura', 'empresa': 'DesarrolladorX', 'descripcion': 'Un juego modificado', 'valoracion': 5}
        response = self.client.post(url, data)
        self.assertEqual(response.status_code, 200)
...
class TestResenasViews(TestCase):
    ...
    def setUp(self):
        ...
        self.resena = Resena.objects.create(
            autor="Lionel Messi",
            contenido="Esta es una reseña de prueba del más grande",
    ...
    def test_agregar_resena_POST(self):
        ...
        self.assertEquals(Resena.objects.last().autor, 'El niño rata')
    ...
    def test_editar_resena_POST(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(Resena.objects.first().autor, 'El niño rata')
